...
export class MaxMintAmountUpdated extends ethereum.Event {
  get params(): MaxMintAmountUpdated__Params {
    return new MaxMintAmountUpdated__Params(this);
  }
}

export class MaxMintAmountUpdated__Params {
  _event: MaxMintAmountUpdated;

  constructor(event: MaxMintAmountUpdated) {
    this._event = event;
  }
...
export class Contract extends ethereum.SmartContract {
  ...
  getMintedBy(account: Address): BigInt {
    let result = super.call("getMintedBy", "getMintedBy(address):(uint256)", [
      ethereum.Value.fromAddress(account),
    ]);
  ...
  try_getMintedBy(account: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "getMintedBy",
      "getMintedBy(address):(uint256)",
      [ethereum.Value.fromAddress(account)],
    );
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  mintedBy(param0: Address): BigInt {
    let result = super.call("mintedBy", "mintedBy(address):(uint256)", [
  ...
  try_mintedBy(param0: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall("mintedBy", "mintedBy(address):(uint256)", [
      ethereum.Value.fromAddress(param0),
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
